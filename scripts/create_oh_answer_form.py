...
"Answer to Complaint in Forcible Entry and Detainer" structure as a fillable PDF.
"""
import fitz

OUT = "app/templates/counties/oh_eviction_answer.pdf"
...
lead = fitz.get_text_length("", fontname="helv", fontsize=11)
text(72, 96, "")
