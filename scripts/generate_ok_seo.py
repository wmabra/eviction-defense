...
def build_county_page(name, cities_in_county):
    ...
    hero = build_hero(
        ...
        f"Start with eight questions. Your Oklahoma and {name} County location is carried into the guided intake and $299 document packet workflow.",
        f'data-state="OK" data-county="{name} County" data-city=""'
    )
...
def main():
    ...
    state_html = build_head(
        ...
        "Start with eight questions. Your Oklahoma location is carried into the guided intake and $299 document packet workflow.",
        'data-state="OK" data-county="" data-city=""'
...
<section class="section"><div class="container"><div class="callout"><h2>Start a packet for Oklahoma</h2><p>Check eligibility before proceeding to the $299 checkout.</p><a class="btn btn-secondary" href="#eligibility">Check eligibility</a></div></div></section>''' + build_footer()
    try:
