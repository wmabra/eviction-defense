...
def state_select_html():
    states = ["AR","CO","CT","GA","IL","LA","MI","MN","MO","NM","OR","RI","SC","TN","TX","VA"]
    names = {"AR":"Arkansas","CO":"Colorado","CT":"Connecticut","GA":"Georgia","IL":"Illinois","LA":"Louisiana","MI":"Michigan","MN":"Minnesota","MO":"Missouri","NM":"New Mexico","OR":"Oregon","RI":"Rhode Island","SC":"South Carolina","TN":"Tennessee","TX":"Texas","VA":"Virginia"}
    out = ""
    for s in states:
...
def build_county_page(name, cities_in_county):
    ...
    hero = build_hero(
        ...
        f"Start with eight questions. Your Missouri and {name} County location is carried into the guided intake and $399 document packet workflow.",
        f'data-state="MO" data-county="{name} County" data-city=""'
    )
...
def main():
    ...
    state_html = build_head(
        ...
        "Start with eight questions. Your Missouri location is carried into the guided intake and $399 document packet workflow.",
        'data-state="MO" data-county="" data-city=""'
...
<section class="section"><div class="container"><div class="callout"><h2>Start a packet for Missouri</h2><p>Check eligibility before proceeding to the $399 checkout.</p><a class="btn btn-secondary" href="#eligibility">Check eligibility</a></div></div></section>''' + build_footer()
    try:
