...
def state_select_html():
    states = ["AR","CO","CT","GA","IL","KY","LA","MI","MN","MO","NM","OR","RI","SC","TN","TX","VA"]
    names = {"AR":"Arkansas","CO":"Colorado","CT":"Connecticut","GA":"Georgia","IL":"Illinois","LA":"Louisiana","MI":"Michigan","MN":"Minnesota","KY":"Kentucky","MO":"Missouri","NM":"New Mexico","OR":"Oregon","RI":"Rhode Island","SC":"South Carolina","TN":"Tennessee","TX":"Texas","VA":"Virginia"}
    out = ""
    for s in states:
...
def build_county_page(name, cities_in_county):
    ...
    hero = build_hero(
        ...
        f"Start with eight questions. Your Kentucky and {name} County location is carried into the guided intake and $399 document packet workflow.",
        f'data-state="KY" data-county="{name} County" data-city=""'
    )
...
def main():
    ...
    state_html = build_head(
        ...
        "Start with eight questions. Your Kentucky location is carried into the guided intake and $399 document packet workflow.",
        'data-state="KY" data-county="" data-city=""'
...
<section class="section"><div class="container"><div class="callout"><h2>Start a packet for Kentucky</h2><p>Check eligibility before proceeding to the $399 checkout.</p><a class="btn btn-secondary" href="#eligibility">Check eligibility</a></div></div></section>''' + build_footer()
    try:
