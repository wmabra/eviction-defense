...
def state_select_html():
    ...
    names = {"AR":"Arkansas","CO":"Colorado","CT":"Connecticut","GA":"Georgia","IL":"Illinois","IN":"Ohio","KY":"Kentucky","LA":"Louisiana","MI":"Michigan","MN":"Minnesota","MO":"Missouri","NM":"New Mexico","OH":"Ohio","OK":"Oklahoma","OR":"Oregon","RI":"Rhode Island","SC":"South Carolina","TN":"Tennessee","TX":"Texas","VA":"Virginia"}
    out = ""
    for s in states:
...
def build_county_page(name, cities_in_county):
    ...
    hero = build_hero(
        ...
        f"Start with eight questions. Your Ohio and {name} County location is carried into the guided intake and $399 document packet workflow.",
        f'data-state="OH" data-county="{name} County" data-city=""'
    )
...
def main():
    ...
    state_html = build_head(
        ...
        "Start with eight questions. Your Ohio location is carried into the guided intake and $399 document packet workflow.",
        'data-state="OH" data-county="" data-city=""'
...
<section class="section"><div class="container"><div class="callout"><h2>Start a packet for Ohio</h2><p>Check eligibility before proceeding to the $399 checkout.</p><a class="btn btn-secondary" href="#eligibility">Check eligibility</a></div></div></section>''' + build_footer()
    try:
