...
COLORADO_COURTHOUSE_ADDRESSES: Dict[str, str] = {
    "adams": "1100 Judicial Center Dr, Brighton, CO 80601",
    "alamosa": "8955 Independence Way, Alamosa, CO 81101",
    "arapahoe": "7325 S. Potomac St, Centennial, CO 80112",
    "archuleta": "440 San Juan St, Pagosa Springs, CO 81147",
    "baca": "741 Main St, Springfield, CO 81073",
    "bent": "725 Bent Ave, Las Animas, CO 81054",
    "boulder": "1777 6th St, Boulder, CO 80302",
    "broomfield": "17 DesCombes Dr, Broomfield, CO 80020",
    "chaffee": "142 Crestone Ave, Salida, CO 81201",
    "cheyenne": "51 S. 1st St, Cheyenne Wells, CO 80810",
    "clear creek": "405 Argentine St, Georgetown, CO 80444",
    "conejos": "6683 County Rd 13, Conejos, CO 81129",
    "costilla": "304 Main St, San Luis, CO 81152",
    "crowley": "110 E. 6th St, Ordway, CO 81063",
    "custer": "205 S. 6th St, Westcliffe, CO 81252",
    "delta": "501 Palmer St, Delta, CO 81416",
    "denver": "1437 Bannock St, Room 135, Denver, CO 80202",
    "dolores": "409 N. Main St, Dove Creek, CO 81324",
    "douglas": "4000 Justice Way, Castle Rock, CO 80109",
    "eagle": "885 Chambers Ave, Eagle, CO 81631",
    "elbert": "751 Ute Ave, Kiowa, CO 80117",
    "el paso": "270 S. Tejon St, Colorado Springs, CO 80903",
    "fremont": "136 Justice Center Rd, Cañon City, CO 81212",
    "garfield": "109 8th St, Glenwood Springs, CO 81601",
    "gilpin": "2960 Dory Hill Rd, Black Hawk, CO 80422",
    "grand": "307 Moffat Ave, Hot Sulphur Springs, CO 80451",
    "gunnison": "200 E. Virginia Ave, Gunnison, CO 81230",
    "hinsdale": "311 Henson St, Lake City, CO 81235",
    "huerfano": "401 Main St, Walsenburg, CO 81089",
    "jackson": "396 2nd St, Walden, CO 80480",
    "jefferson": "100 Jefferson County Pkwy, Golden, CO 80401",
    "kiowa": "1305 Goff St, Eads, CO 81036",
    "kit carson": "251 16th St, Burlington, CO 80807",
    "lake": "505 Harrison Ave, Leadville, CO 80461",
    "la plata": "1060 E. 2nd Ave, Durango, CO 81301",
    "larimer": "201 La Porte Ave, Fort Collins, CO 80521",
    "las animas": "200 E. 1st St, Trinidad, CO 81082",
    "lincoln": "103 3rd Ave, Hugo, CO 80821",
    "logan": "110 N. Riverview Rd, Sterling, CO 80751",
    "mesa": "125 N. Spruce St, Grand Junction, CO 81501",
    "mineral": "1201 N. Main St, Creede, CO 81130",
    "moffat": "1198 W. Victory Way, Craig, CO 81625",
    "montezuma": "865 N. Park St, Cortez, CO 81321",
    "montrose": "1200 N. Grand Ave, Montrose, CO 81401",
    "morgan": "400 Warner St, Fort Morgan, CO 80701",
    "otero": "13 W. 3rd St, La Junta, CO 81050",
    "ouray": "541 4th St, Ouray, CO 81427",
    "park": "300 4th St, Fairplay, CO 80440",
    "phillips": "221 S. Interocean Ave, Holyoke, CO 80734",
    "pitkin": "506 E. Main St, Aspen, CO 81611",
    "prowers": "301 S. Main St, Lamar, CO 81052",
    "pueblo": "501 N. Elizabeth St, Pueblo, CO 81003",
    "rio blanco": "555 Main St, Meeker, CO 81641",
    "rio grande": "965 6th St, Del Norte, CO 81132",
    "routt": "1955 Shield Dr, Steamboat Springs, CO 80487",
    "saguache": "501 4th St, Saguache, CO 81149",
    "san juan": "1557 Greene St, Silverton, CO 81433",
    "san miguel": "305 W. Colorado Ave, Telluride, CO 81435",
    "sedgwick": "315 Cedar St, Julesburg, CO 80737",
    "summit": "501 N. Park Ave, Breckenridge, CO 80424",
    "teller": "101 W. Bennett Ave, Cripple Creek, CO 80813",
    "washington": "26861 US Hwy 34, Akron, CO 80720",
    "weld": "901 9th Ave, Greeley, CO 80631",
    "yuma": "310 Ash St, Wray, CO 80758",
}


def get_colorado_courthouse_address(county: str) -> Optional[str]:
    """Look up official Colorado County Court mailing address for any Colorado county."""
    if not county:
        return None
...
STATE_CONFIGS: Dict[str, StateConfig] = {
    ...
    "GA": {
        ...
        "field_rect_overrides": {
            "fee_waiver_form": {
                "COURT OF": {"y0": 41.0, "y1": 55.5, "text_fontsize": 9, "align": "center"},
                "COUNTY": {"align": "center"},
                "FILE NO": {"align": "center"},
                "undefined_3": {"align": "center"},
                "do hereby swear": {"align": "center"},
                "Model": {"y0": 524.0, "y1": 540.5},
                "Make": {"y0": 524.0, "y1": 540.5},
                "Year": {"y0": 524.0, "y1": 540.5},
            },
            "answer_form": {
        ...
        "fee_waiver_checkbox_map": {
            ...
            "Check Box36": ["employment_income", "self_employment_income", "is_employed"],
            "Check Box37": ["employment_income", "self_employment_income", "is_employed"],
    ...
    "IL": {
        ...
        "field_rect_overrides": {
            "answer_form": {
                "1 - County": {"align": "center"},
                "117": {"align": "center"},
                "118": {"align": "center"},
                "G - Name": {"align": "center"},
                "I - Telephone": {"align": "center"},
                "9 - Case Number": {"align": "center", "text_fontsize": 8.5},
                "10 - Property Address": {"text_fontsize": 8.5},
                "66 -Municipal or County Ordinance": {"text_fontsize": 8.5},
            },
            "fee_waiver_form": {
                "1 - County": {"align": "center"},
                "4 - Case Number": {"align": "center"},
                "Last - Print Name": {"align": "center"},
                "Last - Telephone": {"align": "center"},
            },
        },
    ...
    "CT": {
        ...
        "field_rect_overrides": {
            "answer_form": {
                "form1[0].FRONT[0].CERTNAME[0]": {"y0": 667.0, "y1": 681.0},
                "form1[0].FRONT[0].CERTDATESIGN[0]": {"y0": 667.0, "y1": 681.0, "align": "center"},
                "form1[0].FRONT[0].CERTMAIL[0]": {"y0": 690.0, "y1": 705.0},
                "form1[0].FRONT[0].CERTPHONE[0]": {"y0": 690.0, "y1": 705.0},
                "form1[0].FRONT[0].DOCKETNO[0]": {"align": "center"},
                "DOCKETNO[0]": {"align": "center"},
            },
            "fee_waiver_form": {
                "DOCKETNO[0]": {"align": "center"},
            },
    ...
    "CO": {
        ...
        "fee_waiver_mapping": {
            ...
            "full_name": "Name",
            "date_of_birth": "DoB",
            "interpreter_language": "In Language",
            "address": "4.6",
            "city": "4.7",
            "state": "4.8",
            "zip": "4.9",
        ...
        "skip_financial_when_categorical": False,
        ...
        "radio_selections": {
            ...
            "Group6.1": {"data": "needs_interpreter", "yes": "Yes I need", "no": "No, I don't", "default": "no"},
            "Group6.3": {"data": "prefers_remote", "yes": "remotely", "no": "in-person", "default": "no"},
            ...
            "Group7A.0": {"any_defense": ["def_paid", "def_attempted_pay", "def_partial_pay", "def_repairs"], "or_has_complaint_amount": True, "yes": "yes", "no": "no"},
        ...
        "defense_options": [
            ...
            {"key": "def_paid", "section": "Section 7a — Defenses for Unpaid Rent (Did your landlord claim unpaid rent?)", "label": "I paid all rent owed", "field": "7A.1"},
            {"key": "def_attempted_pay", "section": "Section 7a — Defenses for Unpaid Rent (Did your landlord claim unpaid rent?)", "label": "I tried to pay but landlord refused", "field": "7A.2"},
            {"key": "def_partial_pay", "section": "Section 7a — Defenses for Unpaid Rent (Did your landlord claim unpaid rent?)", "label": "I paid partial rent after demand", "field": "7A.3"},
            {"key": "def_repairs", "section": "Section 7a — Defenses for Unpaid Rent (Did your landlord claim unpaid rent?)", "label": "Warranty of Habitability (Unfixed Repairs)", "field": "7A.4"},
            # Section 7B — Lease Violation Defenses
            {"key": "def_not_violate", "section": "Section 7b — Defenses for Lease Violations (Did your landlord claim lease violations?)", "label": "Did not violate material lease condition", "field": "7B.1"},
            {"key": "def_not_repeat", "section": "Section 7b — Defenses for Lease Violations (Did your landlord claim lease violations?)", "label": "Did not repeat alleged violation", "field": "7B.2"},
            {"key": "def_domestic_violence", "section": "Section 7b — Defenses for Lease Violations (Did your landlord claim lease violations?)", "label": "Violation resulted from domestic violence or disability", "field": "7B.3"},
            # Section 7C — Substantial Violation
            {"key": "def_no_substantial_violation", "section": "Section 7c — Substantial Lease Violations", "label": "Did not commit substantial violation", "field": "7C.1"},
            # Section 7D — Retaliation / Just Cause
            {"key": "def_retaliation", "section": "Section 7d — Defenses for Ending Tenancy (No-Fault / Non-Renewal)", "label": "Retaliatory eviction for reporting repair violations", "field": "7D.1"},
            {"key": "def_no_fault_just_cause", "section": "Section 7d — Defenses for Ending Tenancy (No-Fault / Non-Renewal)", "label": "Landlord lacked just cause for non-renewal", "field": "7D.2"},
        ...
        "field_rect_overrides": {
            "answer_form": {
                "Court County": {"align": "center"},
                "Court Address": {"text_fontsize": 8.0},
                "Case Number": {"align": "center"},
                "Sig1_Date": {"align": "center"},
                "Sig1_Month": {"align": "center"},
                "Sig1_Year": {"align": "center"},
                "Sig1_State": {"align": "center"},
                "8.0": {"x1": 542.0},
            },
            "fee_waiver_form": {
                "Sig1_City": {"y0": 624.0, "y1": 636.0},
                "Sig1_State": {"y0": 641.5, "y1": 653.5, "align": "center"},
                "Sig1_Date": {"y0": 606.5, "y1": 618.5, "align": "center"},
                "Sig1_Month": {"y0": 606.5, "y1": 618.5, "align": "center"},
                "Sig1_Year": {"y0": 606.5, "y1": 618.5, "align": "center"},
                "County": {"align": "center"},
                "Case Number": {"align": "center"},
            }
        },
        ...
        "county_form_overrides": {
            "Denver": {
                ...
                "overlay_positions": {
                    ...
                    "phone": {"page": 1, "x": 138, "y": 229, "w": 58, "h": 13, "size": 8.0},
                    "email": {"page": 1, "x": 232, "y": 228, "w": 145, "h": 13, "size": 8.5},
                    "case_number": {"page": 1, "x": 460, "y": 185, "w": 95, "h": 14, "size": 9.5, "align": "center"},
                    "printed_name": {"page": 1, "x": 140, "y": 288, "w": 230, "h": 14, "size": 11, "align": "center"},
                    "defense_narrative": {"page": 1, "x": 54, "y": 475, "w": 504, "h": 130, "size": 8.5},
                    "signature": {"page": 2, "x": 60, "y": 458, "w": 250, "h": 20, "size": 11},
                    "property_address": {"page": 2, "x": 190, "y": 496, "w": 360, "h": 14, "size": 10},
                    "phone_bottom": {"page": 2, "x": 210, "y": 519, "w": 200, "h": 14, "size": 10},
                    ...
                    "cos_date": {"page": 2, "x": 122, "y": 565, "w": 84, "h": 14, "size": 9, "align": "center"},
                    "cos_recipient": {"page": 2, "x": 188, "y": 578, "w": 340, "h": 13, "size": 8.5},
                    "cos_address": {"page": 2, "x": 54, "y": 635, "w": 230, "h": 14, "size": 9},
                },
            },
        },
    },
    ...
    "LA": {
        ...
        "field_rect_overrides": {
            "fee_waiver_form": {
                "Docket Number": {"align": "center"},
                "Parish": {"align": "center"},
                "Your Full Name": {"align": "center"},
                "Balance Owed - Livestock": {"y1": 391.0},
                "Credit Card Name 02": {"y1": 753.0},
            },
        },
        "field_mapping": {},
        "overlay_positions": {
            "landlord_name": {"page": 3, "x": 150, "y": 85, "w": 150, "h": 14, "size": 9.5},
            "case_number": {"page": 3, "x": 405, "y": 85, "w": 140, "h": 14, "size": 9.5, "align": "center"},
            "full_name": {"page": 3, "x": 150, "y": 189, "w": 230, "h": 16, "size": 10, "align": "center"},
            "court_name": {"page": 3, "x": 460, "y": 191, "w": 180, "h": 16, "size": 9},
            # Page 11: Section 5 notary verification block (La. C.C.P. art. 4735).
            "full_name_p11": {"page": 11, "x": 75, "y": 226, "w": 210, "h": 16, "size": 11, "align": "center"},
            "date_p11": {"page": 11, "x": 75, "y": 366, "w": 210, "h": 16, "size": 11, "align": "center"},
        },
        "defense_options": [
    ...
    "AR": {
        ...
        "fee_waiver_checkbox_map": {
            "Check Box1": ["employment_income", "self_employment_income", "is_employed"],
        ...
        "field_rect_overrides": {
            "fee_waiver_form": {
                "NO": {"y0": 244.5, "y1": 258.5, "align": "center"},
        ...
        "overlay_positions": {
            "county": {"page": 6, "x": 243, "y": 158, "w": 163, "h": 14, "size": 11, "align": "center"},
            "plaintiff_name": {"page": 6, "x": 72, "y": 202, "w": 178, "h": 14, "size": 10, "align": "center"},
            ...
            "defense_line_2": {"page": 8, "x": 66, "y": 394.0, "w": 468, "h": 13.5, "size": 8.0},
            "defense_line_3": {"page": 8, "x": 66, "y": 425.5, "w": 468, "h": 13.5, "size": 8.0},
            "defense_line_4": {"page": 8, "x": 66, "y": 457.0, "w": 468, "h": 13.5, "size": 8.0},
            "defense_line_5": {"page": 8, "x": 66, "y": 488.5, "w": 468, "h": 13.5, "size": 8.0},
            "counterclaim_line1": {"page": 8, "x": 386, "y": 571, "w": 150, "h": 13.5, "size": 8.5},
            "counterclaim_line2": {"page": 8, "x": 66, "y": 601, "w": 468, "h": 13.5, "size": 8.5},
            "signature": {"page": 9, "x": 408, "y": 685, "w": 92, "h": 20, "size": 10},
            "address": {"page": 10, "x": 374, "y": 78, "w": 166, "h": 14, "size": 10},
            "city_state_zip_p10": {"page": 10, "x": 310, "y": 105, "w": 230, "h": 14, "size": 10},
            "phone": {"page": 10, "x": 358, "y": 133, "w": 182, "h": 14, "size": 10},
            "date": {"page": 10, "x": 350, "y": 485, "w": 154, "h": 14, "size": 10, "align": "center"},
            "full_name": {"page": 10, "x": 102, "y": 236, "w": 286, "h": 14, "size": 11, "align": "center"},
            "cos_recipient": {"page": 10, "x": 254, "y": 273, "w": 234, "h": 14, "size": 10, "align": "center"},
            "cos_address": {"page": 10, "x": 207, "y": 310, "w": 327, "h": 14, "size": 9},
        },
    ...
    "MN": {
        ...
        "overlay_positions": {
            ...
            # Defense explanations routed to ruled lines under items 5/6/9
            "explanation_def_amount_1": {"page": 2, "x": 94, "y": 435.0, "w": 440, "h": 12.5, "size": 8.5},
            "explanation_def_amount_2": {"page": 2, "x": 94, "y": 456.5, "w": 440, "h": 12.5, "size": 8.5},
            "explanation_def_bad_notice_1": {"page": 2, "x": 94, "y": 561.0, "w": 440, "h": 12.5, "size": 8.5},
        ...
        "fee_waiver_overlay": {
            "county": {"page": 1, "x": 132, "y": 114, "w": 150, "h": 13, "size": 10, "align": "center"},
            "case_number": {"page": 1, "x": 408, "y": 114, "w": 132, "h": 13, "size": 10, "align": "center"},
            "plaintiff_name": {"page": 1, "x": 170, "y": 195, "w": 230, "h": 14, "size": 11},
            "judicial_district": {"page": 1, "x": 150, "y": 142, "w": 100, "h": 14, "size": 10, "align": "center"},
            ...
            "phone": {"page": 6, "x": 118, "y": 428, "w": 180, "h": 10.5, "size": 9},
            "email": {"page": 6, "x": 112, "y": 443.5, "w": 240, "h": 10.5, "size": 9},
        }},
    ...
    "MI": {
        ...
        "field_rect_overrides": {
            "answer_form": {
                "Defendant name, address, and telephone number": {
                    "x0": 330.0, "y0": 165.0, "x1": 572.0, "y1": 224.0, "text_fontsize": 9.5
                },
                "Judicial district": {"align": "center"},
                "Case number": {"align": "center"},
                "Date": {"align": "center"},
                "Enter date": {"align": "center"},
            },
            "fee_waiver_form": {
                "district": {"align": "center"},
                "county": {"align": "center"},
                "caseno": {"align": "center"},
                "Date": {"align": "center"},
                "Number in household": {"align": "center"},
                "My Gross Household Income is in Dollars": {"align": "center"},
            },
        },
        "field_mapping": {
    ...
    "MO": {
        ...
        "field_rect_overrides": {
            ...
            "fee_waiver_form": {
                ...
                "Petitioner Name": {"y0": 114.0, "y1": 142.0},
                ...
                "Retirement/Pension": {"y0": 322.0, "y1": 336.0, "text_fontsize": 8.5},
                "Social Security": {"y0": 336.0, "y1": 350.0, "text_fontsize": 8.5},
                "Child Support": {"y0": 350.0, "y1": 364.0, "text_fontsize": 8.5},
                "Maintenance - Income": {"y0": 364.0, "y1": 378.0, "text_fontsize": 8.5},
                "Other Income Amount": {"y0": 378.0, "y1": 392.0, "text_fontsize": 8.5},
                "Total Monthly Income": {"y0": 418.0, "y1": 432.0, "text_fontsize": 8.5},
                # Expenses
                "Mortgage or Rent Payment Amount": {"y0": 293.0, "y1": 307.0, "text_fontsize": 8.5},
                "Utilities Amount": {"y0": 308.0, "y1": 322.0, "text_fontsize": 8.5},
                "Food Amount": {"y0": 322.0, "y1": 336.0, "text_fontsize": 8.5},
                "Payment on Debts and Credit Cards": {"y0": 336.0, "y1": 350.0, "text_fontsize": 8.5},
                "Child Support - Expense": {"y0": 350.0, "y1": 364.0, "text_fontsize": 8.5},
                "Maintenance": {"y0": 364.0, "y1": 378.0, "text_fontsize": 8.5},
                "Medical Expenses": {"y0": 378.0, "y1": 392.0, "text_fontsize": 8.5},
                "Total Monthly Expenses": {"y0": 418.0, "y1": 432.0, "text_fontsize": 8.5},
                # Assets & Debts
                "Cash on Hand": {"y0": 461.0, "y1": 475.0, "text_fontsize": 8.5},
                "Checking Account": {"y0": 488.0, "y1": 502.0, "text_fontsize": 8.5},
                "Savings Account": {"y0": 503.0, "y1": 517.0, "text_fontsize": 8.5},
                "Total Assets": {"y0": 669.0, "y1": 683.0, "text_fontsize": 8.5},
                "Home Loan Balance": {"y0": 461.0, "y1": 475.0, "text_fontsize": 8.5},
                "Automobile Loan": {"y0": 475.0, "y1": 489.0, "text_fontsize": 8.5},
                "Credit Card Balance(s)": {"y0": 488.0, "y1": 502.0, "text_fontsize": 8.5},
                "Total Debts": {"y0": 669.0, "y1": 683.0, "text_fontsize": 8.5},
            },
        },
        "fee_waiver_checkbox_overrides": {
            "Mortgage": False,
    ...
    "KY": {
        ...
        "field_rect_overrides": {
            ...
            "fee_waiver_form": {
                "Case Number": {"align": "center"},
                "County Dropdown": {"align": "center"},
                "Text Field 109": {"align": "center"},
                "Text Field 1010": {"align": "center"},
            },
        },
        "field_mapping": {
            "division": "division",
    ...
    "IN": {
        ...
        "field_rect_overrides": {
            ...
            "fee_waiver_form": {
                "__all_text__": {"text_fontsize": 10.0},
                "Address": {"y0": 655.0},
                "MonthlySSI/SSD": {"y1": 516.0},
                "Name": {"align": "center"},
                "County": {"align": "center"},
            },
        },
