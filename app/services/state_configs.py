...
STATE_CONFIGS: Dict[str, StateConfig] = {
    ...
    "GA": {
        ...
        "field_rect_overrides": {
            ...
            "answer_form": {
                ...
                "Date.CurrentDate.SlashMDY": {"dy1": -2.5, "align": "center"},
                "County.Selection": {"dy1": -2.5, "align": "center"},
                "CaseNumber": {"dy1": -2.5, "align": "center"},
                "Defendant.SEQ001.HomeAddress.Full": {"dy1": -2.5},
                "Defendant.SEQ001.HomeAddress.CityStateZip": {"dy1": -2.5},
            },
        },
    ...
    "IL": {
        ...
        "field_rect_overrides": {
            "answer_form": {
                "__all_text__": {"dy1": -2.5},
                "1 - County": {"align": "center"},
                "117": {"align": "center"},
                "118": {"align": "center"},
                "G - Name": {"align": "center"},
                "I - Telephone": {"align": "center"},
                "9 - Case Number": {"align": "center"},
            },
            "fee_waiver_form": {
                "__all_text__": {"dy1": -2.5},
                "1 - County": {"align": "center"},
    ...
    "CT": {
        ...
        "field_rect_overrides": {
            ...
            "fee_waiver_form": {
                "__all_text__": {"dx0": 2.5, "dy0": 2.5, "dx1": -2.5, "dy1": -2.5},
                "DOCKETNO[0]": {"align": "center"},
            },
        },
        "field_mapping": {
        ...
        "county_form_overrides": {
            "Denver": {
                ...
                "overlay_positions": {
                    ...
                    "phone": {"page": 1, "x": 138, "y": 231, "w": 58, "h": 11, "size": 7.5},
                    "email": {"page": 1, "x": 232, "y": 230, "w": 145, "h": 11, "size": 9},
                    "case_number": {"page": 1, "x": 460, "y": 187, "w": 95, "h": 11, "size": 10, "align": "center"},
                    ...
                    "cos_date": {"page": 2, "x": 122, "y": 569, "w": 84, "h": 10, "size": 9, "align": "center"},
                    "cos_recipient": {"page": 2, "x": 188, "y": 582, "w": 340, "h": 9.0, "size": 8.0},
                    "cos_address": {"page": 2, "x": 54, "y": 638, "w": 230, "h": 11, "size": 9},
                },
            },
        },
    },
    ...
    "IN": {
        ...
        "field_rect_overrides": {
            ...
            "fee_waiver_form": {
                "__all_text__": {"dx0": 16.0, "dy0": 2.0, "dy1": -2.0},
                "Address": {"y0": 655.0},
                "MonthlySSI/SSD": {"y1": 516.0},
                "Name": {"dy1": -6.0, "align": "center"},
                "County": {"dy1": -5.0, "align": "center"},
            },
        },
        "has_fillable_fields": True,
